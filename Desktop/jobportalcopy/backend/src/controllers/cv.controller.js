...
async function uploadCV(req, res) {
  try {
    ...
    // Save file to uploads directory (or cloud storage in production)
    ...
    // Save LaTeX file
    const latexFileName = `${candidateId}_${Date.now()}_cv.tex`;
    const latexFilePath = path.join(uploadsDir, latexFileName);
    ...
    res.json({
      ...
      data: {
        ...
        latexFileUrl: `/uploads/${latexFileName}`,
        extractedData: {
